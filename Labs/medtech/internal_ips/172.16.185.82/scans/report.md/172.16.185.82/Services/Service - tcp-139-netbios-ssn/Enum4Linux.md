```bash
enum4linux-ng -A -d -v 172.16.185.82 2>&1
```

[/home/kali/Notes/Labs/medtech/internal_ips/172.16.185.82/scans/tcp139/enum4linux-ng.txt](file:///home/kali/Notes/Labs/medtech/internal_ips/172.16.185.82/scans/tcp139/enum4linux-ng.txt):
...
|    Target Information    |
 ==========================
[94m[*] Target ........... 172.16.185.82[0m
[94m[*] Username ......... ''[0m
[94m[*] Random Username .. 'dwaniqlw'[0m
[94m[*] Password ......... ''[0m
[94m[*] Timeout .......... 5 second(s)[0m

 ======================================
|    Listener Scan on 172.16.185.82    |
 ======================================
...
[92m[+] SMB over NetBIOS is accessible on 139/tcp[0m
 ...
 ============================================================
|    NetBIOS Names and Workgroup/Domain for 172.16.185.82    |
 ============================================================
[V] Trying to get NetBIOS names information, running command: nmblookup -s /tmp/tmpxs1mkdza -A 172.16.185.82
[92m[+] Got domain/workgroup name: MEDTECH[0m
[92m[+] Full NetBIOS names information:
- CLIENT01        <20> -         B <ACTIVE>  File Server Service
- CLIENT01        <00> -         B <ACTIVE>  Workstation Service
- MEDTECH         <00> - <GROUP> B <ACTIVE>  Domain/Workgroup Name
- MAC Address = 00-50-56-BF-0C-26[0m

 ==========================================
|    SMB Dialect Check on 172.16.185.82    |
 ==========================================
...
SMB signing required: false[0m
 ...
 ============================================================
|    Domain Information via SMB session for 172.16.185.82    |
 ============================================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
[92m[+] Found domain information via SMB
NetBIOS computer name: CLIENT01
NetBIOS domain name: MEDTECH
DNS domain: medtech.com
FQDN: CLIENT01.medtech.com
Derived membership: domain member
Derived domain: MEDTECH[0m

 ==========================================
|    RPC Session Check on 172.16.185.82    |
 ==========================================
[94m[*] Check for null session[0m
[V] Attempting to make session, running command: smbclient -W MEDTECH -U % -s /tmp/tmpxs1mkdza -t 5 -c help '//172.16.185.82/ipc$'
[91m[-] Could not establish null session: STATUS_ACCESS_DENIED[0m
[94m[*] Check for random user[0m
[V] Attempting to make session, running command: smbclient -W MEDTECH -U dwaniqlw% -s /tmp/tmpxs1mkdza -t 5 -c help '//172.16.185.82/ipc$'
...
[91m[-] Sessions failed, neither null nor user sessions were possible[0m
 ...
 ================================================
|    OS Information via RPC for 172.16.185.82    |
 ================================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
