...
[/home/kali/Notes/Labs/medtech/192.168.227.121/scans/tcp139/enum4linux-ng.txt](file:///home/kali/Notes/Labs/medtech/192.168.227.121/scans/tcp139/enum4linux-ng.txt):
...
|    Target Information    |
 ==========================
[94m[*] Target ........... 192.168.227.121[0m
[94m[*] Username ......... ''[0m
[94m[*] Random Username .. 'ddlmeyxp'[0m
[94m[*] Password ......... ''[0m
[94m[*] Timeout .......... 5 second(s)[0m

 ========================================
|    Listener Scan on 192.168.227.121    |
 ========================================
...
[92m[+] SMB over NetBIOS is accessible on 139/tcp[0m
 ...
 ==============================================================
|    NetBIOS Names and Workgroup/Domain for 192.168.227.121    |
 ==============================================================
[V] Trying to get NetBIOS names information, running command: nmblookup -s /tmp/tmp2jm6z2y7 -A 192.168.227.121
[91m[-] Could not get NetBIOS names information via 'nmblookup': timed out[0m

 ============================================
|    SMB Dialect Check on 192.168.227.121    |
 ============================================
...
SMB signing required: false[0m
 ...
 ==============================================================
|    Domain Information via SMB session for 192.168.227.121    |
 ==============================================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
[92m[+] Found domain information via SMB
NetBIOS computer name: WEB02
NetBIOS domain name: MEDTECH
DNS domain: medtech.com
FQDN: WEB02.dmz.medtech.com
Derived membership: domain member
Derived domain: MEDTECH[0m

 ============================================
|    RPC Session Check on 192.168.227.121    |
 ============================================
[94m[*] Check for null session[0m
[V] Attempting to make session, running command: smbclient -W MEDTECH -U % -s /tmp/tmp2jm6z2y7 -t 5 -c help '//192.168.227.121/ipc$'
[91m[-] Could not establish null session: STATUS_ACCESS_DENIED[0m
[94m[*] Check for random user[0m
[V] Attempting to make session, running command: smbclient -W MEDTECH -U ddlmeyxp% -s /tmp/tmp2jm6z2y7 -t 5 -c help '//192.168.227.121/ipc$'
...
[91m[-] Sessions failed, neither null nor user sessions were possible[0m
 ...
 ==================================================
|    OS Information via RPC for 192.168.227.121    |
 ==================================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
