...
[/home/kali/Notes/Labs/medtech/192.168.227.121/scans/tcp80/tcp_80_http_curl.html](file:///home/kali/Notes/Labs/medtech/192.168.227.121/scans/tcp80/tcp_80_http_curl.html):
...
Date: Mon, 29 Jul 2024 11:57:02 GMT
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head><title>
	MedTech
</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="application-name" content="MedTech" /><meta name="author" content="Offensive Security" /><meta name="description" content="MedTech" /><meta name="keywords" content="MedTech" /><link media="all" href="assets/css/style.css" rel="stylesheet" type="text/css" /><link id="favicon" rel="shortcut icon" type="image/png" href="assets/img/favicon.png" /></head>
	<body>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="default.aspx" style="font-size:28px; color:#000;">MedTech</a>
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right-btn f-right d-none d-lg-block ml-15">
                                    <a href="login.aspx" class="btn header-btn">Make an Appointment</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
                            ...
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                             <div class="hero-wrapper">
                                ...
                                <div class="hero__caption">
                                    ...
                                    <a href="services.aspx" class="btn" data-animation="fadeInLeft" data-delay=".3s">Take a Service</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="wants-wrapper w-padding2">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4">
                    <a href="services.aspx" class="btn f-right sm-left">Take a Service</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        ...
                        <div class="blog-cap">
                            <h3><a href="blog_details.aspx">Your daily meal plan</a></h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        ...
                        <div class="blog-cap">
                            <h3><a href="blog_details.aspx">Food is a great source of  medicine</a></h3>
                            <P>Praesent porttitor, nulla vitae posuere iaculis, arcu nisl dignissim dolor, a pretium mi
                            sem ut ipsum.</P>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        ...
                        <div class="blog-cap">
                            <h3><a href="blog_details.aspx">Everyday diet plan</a></h3>
                            <P>Praesent porttitor, nulla vitae posuere iaculis, arcu nisl dignissim dolor, a pretium mi
                            sem ut ipsum.</P>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-5  col-lg-6 col-md-10 offset-xl-1">
                    <div class="about-caption mb-50">
                        ...
                        <a href="about.aspx" class="border-btn">Make an Appointment</a>
                    </div>
                </div>
