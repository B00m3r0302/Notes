...
[/home/kali/Notes/Labs/htb/reel/scans/tcp139/enum4linux-ng.txt](file:///home/kali/Notes/Labs/htb/reel/scans/tcp139/enum4linux-ng.txt):
...
|    Target Information    |
 ==========================
[94m[*] Target ........... 10.10.10.77[0m
[94m[*] Username ......... ''[0m
[94m[*] Random Username .. 'knwmwbww'[0m
[94m[*] Password ......... ''[0m
[94m[*] Timeout .......... 5 second(s)[0m

 ====================================
|    Listener Scan on 10.10.10.77    |
 ====================================
...
[92m[+] SMB over NetBIOS is accessible on 139/tcp[0m
 ...
 ==========================================================
|    NetBIOS Names and Workgroup/Domain for 10.10.10.77    |
 ==========================================================
[V] Trying to get NetBIOS names information, running command: nmblookup -s /tmp/tmp0s41_dj8 -A 10.10.10.77
[91m[-] Could not get NetBIOS names information via 'nmblookup': timed out[0m

 ========================================
|    SMB Dialect Check on 10.10.10.77    |
 ========================================
...
Derived domain: HTB[0m
 ...
 ========================================
|    RPC Session Check on 10.10.10.77    |
 ========================================
[94m[*] Check for null session[0m
[V] Attempting to make session, running command: smbclient -W HTB -U % -s /tmp/tmp0s41_dj8 -t 5 -c help '//10.10.10.77/ipc$'
[92m[+] Server allows session using username '', password ''[0m
[94m[*] Check for random user[0m
[V] Attempting to make session, running command: smbclient -W HTB -U knwmwbww% -s /tmp/tmp0s41_dj8 -t 5 -c help '//10.10.10.77/ipc$'
[91m[-] Could not establish random user session: STATUS_LOGON_FAILURE[0m

 ==================================================
|    Domain Information via RPC for 10.10.10.77    |
 ==================================================
[V] Attempting to get domain SID, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c lsaquery 10.10.10.77
[92m[+] Domain: HTB[0m
[92m[+] Domain SID: S-1-5-21-2648318136-3688571242-2924127574[0m
[92m[+] Membership: domain member[0m

 ==============================================
|    OS Information via RPC for 10.10.10.77    |
 ==============================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
[92m[+] Found OS information via SMB[0m
[94m[*] Enumerating via 'srvinfo'[0m
[V] Attempting to get OS info with command, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c srvinfo 10.10.10.77
...
Server type string: null[0m
 ...
 ====================================
|    Users via RPC on 10.10.10.77    |
 ====================================
[94m[*] Enumerating users via 'querydispinfo'[0m
[V] Attempting to get userlist, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c querydispinfo 10.10.10.77
[91m[-] Could not find users via 'querydispinfo': STATUS_ACCESS_DENIED[0m
[94m[*] Enumerating users via 'enumdomusers'[0m
[V] Attempting to get userlist, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c enumdomusers 10.10.10.77
[91m[-] Could not find users via 'enumdomusers': STATUS_ACCESS_DENIED[0m

 =====================================
|    Groups via RPC on 10.10.10.77    |
 =====================================
[94m[*] Enumerating local groups[0m
[V] Attempting to get local groups, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c 'enumalsgroups domain' 10.10.10.77
[91m[-] Could not get groups via 'enumalsgroups domain': STATUS_ACCESS_DENIED[0m
[94m[*] Enumerating builtin groups[0m
[V] Attempting to get builtin groups, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c 'enumalsgroups builtin' 10.10.10.77
[91m[-] Could not get groups via 'enumalsgroups builtin': STATUS_ACCESS_DENIED[0m
[94m[*] Enumerating domain groups[0m
[V] Attempting to get domain groups, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c enumdomgroups 10.10.10.77
[91m[-] Could not get groups via 'enumdomgroups': STATUS_ACCESS_DENIED[0m

 =====================================
|    Shares via RPC on 10.10.10.77    |
 =====================================
[V] Attempting to get share list using authentication, running command: smbclient -W HTB -U % -s /tmp/tmp0s41_dj8 -t 5 -L //10.10.10.77 -g
[94m[*] Enumerating shares[0m
[92m[+] Found 0 share(s) for user '' with password '', try a different user[0m

 ========================================
|    Policies via RPC for 10.10.10.77    |
 ========================================
...
[91m[-] SMB connection error on port 139/tcp: session failed[0m
 ...
 ========================================
|    Printers via RPC for 10.10.10.77    |
 ========================================
[V] Attempting to get printer info, running command: rpcclient -W HTB -U % -s /tmp/tmp0s41_dj8 -c enumprinters 10.10.10.77
[91m[-] Could not get printer info via 'enumprinters': STATUS_ACCESS_DENIED[0m

Completed after 23.24 seconds
