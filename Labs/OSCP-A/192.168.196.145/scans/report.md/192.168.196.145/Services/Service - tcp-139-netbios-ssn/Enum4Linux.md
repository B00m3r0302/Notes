...
[/home/kali/Notes/Labs/OSCP-A/192.168.196.145/scans/tcp139/enum4linux-ng.txt](file:///home/kali/Notes/Labs/OSCP-A/192.168.196.145/scans/tcp139/enum4linux-ng.txt):
...
|    Target Information    |
 ==========================
[94m[*] Target ........... 192.168.196.145[0m
[94m[*] Username ......... ''[0m
[94m[*] Random Username .. 'tutohcyx'[0m
[94m[*] Password ......... ''[0m
[94m[*] Timeout .......... 5 second(s)[0m

 ========================================
|    Listener Scan on 192.168.196.145    |
 ========================================
...
[92m[+] SMB over NetBIOS is accessible on 139/tcp[0m
 ...
 ==============================================================
|    NetBIOS Names and Workgroup/Domain for 192.168.196.145    |
 ==============================================================
[V] Trying to get NetBIOS names information, running command: nmblookup -s /tmp/tmpedkwbm0j -A 192.168.196.145
[91m[-] Could not get NetBIOS names information via 'nmblookup': timed out[0m

 ============================================
|    SMB Dialect Check on 192.168.196.145    |
 ============================================
...
SMB signing required: false[0m
 ...
 ==============================================================
|    Domain Information via SMB session for 192.168.196.145    |
 ==============================================================
...
Derived domain: unknown[0m
 ...
 ============================================
|    RPC Session Check on 192.168.196.145    |
 ============================================
[94m[*] Check for null session[0m
[V] Attempting to make session, running command: smbclient -W WORKGROUP -U % -s /tmp/tmpedkwbm0j -t 5 -c help '//192.168.196.145/ipc$'
[91m[-] Could not establish null session: STATUS_ACCESS_DENIED[0m
[94m[*] Check for random user[0m
[V] Attempting to make session, running command: smbclient -W WORKGROUP -U tutohcyx% -s /tmp/tmpedkwbm0j -t 5 -c help '//192.168.196.145/ipc$'
...
[91m[-] Sessions failed, neither null nor user sessions were possible[0m
 ...
 ==================================================
|    OS Information via RPC for 192.168.196.145    |
 ==================================================
[94m[*] Enumerating via unauthenticated SMB session on 445/tcp[0m
